...
// Prepare request.
String image = args.Length > 0 ? args[0] : "https://storage.googleapis.com/api4ai-static/samples/alco-rec-1.jpg";
...
JsonArray labels = docRoot["results"]![0]!["entities"]![0]!["array"]!.AsArray();
Console.WriteLine($"[i] Labels:\n{labels}");
